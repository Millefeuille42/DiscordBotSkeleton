...
func SendHelp(agent sessionAgent.DiscordAgent) {
	...
	utils.SendMessageWithMention("Here. And, please, stop asking for help. Look the message history, somebody probably already asked...", "", agent)
